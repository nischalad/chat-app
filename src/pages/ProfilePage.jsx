...
const ProfilePage = () => {
  ...
  const[bio, setBio] = useState("Hii everyone... lets connect")
  ...
  return (
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-between'>
      <div className='w-5/6 max-w-2xl backdrop-blur-2xl text-gray-300 border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
          <form 
            ...
            <input 
              ...
              className='p-2 border border-gray-500 rounded-md focus:outline-none focoss:ring-2 focus:ring-violet-500 ' />
            <textarea 
