      ...
      <form className='border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
        ...
        {currState === "Sign up" && isDataSubmitted && (
          <textarea 
            ...
            value={bio}
            rows={4} 
            className='p-2 border border-gray-500 rounded-md focus:outline-none focus:rin-2 focus:ring-indigo-500'
        ...
        <button 
          type='submit'
          className='py-3 bg-gradient-to-r from-purple-400 to-violet-600 text-whote rounded-md cursor-pointer'>
